        ...
        >
          <div className="space-y-3">
            ...
            <p className="text-xs sm:text-sm text-gray-600 font-medium leading-relaxed max-w-2xl">
              Esqueça checagens manuais no fim do dia. O Padariaio monitora datas de vencimento de insumos e produtos finalizados, gerando relatórios automáticos e alertas visuais no sistema por nível de urgência.
            </p>
